...
namespace Cubiquity
{
	ColouredCubicSurfaceExtractionTask::ColouredCubicSurfaceExtractionTask(OctreeNode< Colour >* octreeNode, ::PolyVox::POLYVOX_VOLUME<Colour>* polyVoxVolume)
		:Task()
	...
	void ColouredCubicSurfaceExtractionTask::process(void)
	{
		...
		{
			::PolyVox::CubicSurfaceExtractor< ::PolyVox::POLYVOX_VOLUME<Colour>, ColouredCubesIsQuadNeeded > surfaceExtractor(mPolyVoxVolume, mOctreeNode->mRegion, mPolyVoxMesh, ::PolyVox::WrapModes::Border, Colour(), true, isQuadNeeded);
