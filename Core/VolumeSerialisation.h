...
namespace Cubiquity
{
	...
	VolumeType* importVolDat(std::string folder, uint32_t blockSize, uint32_t baseNodeSize)
	{
		...
		VolumeType* volume = new VolumeType(Region(0, 0, 0, volumeWidth - 1, sliceCount - 1, volumeHeight - 1), blockSize, baseNodeSize);
