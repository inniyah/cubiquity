...
public class GameLogic : MonoBehaviour
{
	...
	void Update()
	{
		...
		uint hit = 42;
		CubiquityDLL.cuPickVoxel((uint)colouredCubesVolume.volumeHandle, ray.origin.x, ray.origin.y, ray.origin.z, dir.x, dir.y, dir.z, out resultX, out resultY, out resultZ, out hit);
