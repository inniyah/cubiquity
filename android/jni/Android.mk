...
LOCAL_SRC_FILES := ../../gameplay/gameplay/src/gameplay-main-android.cpp ArraySizes.cpp Colour.cpp GradientEstimators.cpp Main.cpp MeshDecimator.cpp MultiMaterial.cpp RandomVectors.cpp VertexTypes.cpp VoxelFilters.cpp Log.cpp MarchingCubesTables.cpp RandomUnitVectors.cpp Region.cpp Utility.cpp VolumeRegion.cpp
